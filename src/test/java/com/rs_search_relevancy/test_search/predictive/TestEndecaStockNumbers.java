...
public class TestEndecaStockNumbers {
    ...
    public TestEndecaStockNumbers(String searchInterface, String searchTerm, boolean resultsReturned, String wildCard){
...
//            { "I18NsearchByStockNumber", "776 - 0939", true, "NONE"},
    ...
    private void assertResultsContainQuery(EndecaResult result){
    	...
    	if (resultItems.size() == 0){
    		Assert.assertTrue("0 Results returned BUT expected results returned to be " + resultsReturned, !resultsReturned);
