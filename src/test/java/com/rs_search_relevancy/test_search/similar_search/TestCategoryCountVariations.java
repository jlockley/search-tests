...
public class TestCategoryCountVariations {
    ...
    public TestCategoryCountVariations(String searchInterface, String searchTerm, String searchTerm2) throws Exception{
    ...
    public static ArrayList<String> getFamilies(String searchTerm) {
    	families = SIMILAR_SEARCH.createFamilies("voltage_variations", searchTerm, "category_count_families");
    	return families;
    }
    
    @Parameters(name= "{1} VS {2}")
    public static List<Object[]> getTestData(){
    	return SIMILAR_SEARCH.createTestData("#", "voltage_variations", "category_count_data");
    }
    ...
    private void outputResultObjects(Integer resultSize1, Integer resultSize2){
		...
		Output.toSpreadsheet("voltage_variations", resultMap.get("environment"), resultMap.get("locale"), resultObj1, resultObj2);
    }
